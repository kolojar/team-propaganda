...
<body>
    <main style="position: relative;">
        ...
        echo "<img id='map' src='../assets/maps/map$floor.jpg' style='display: block;' class='map'>";


        $sites = $conn->query("SELECT * FROM sites_teamPropaganda s NATURAL RIGHT JOIN companies_teamPropaganda c JOIN company_days_teamPropaganda cd ON s.id_company_days = cd.id_company_days WHERE cd.registration_close < CURRENT_TIMESTAMP() AND CURRENT_TIMESTAMP() < cd.active_until;");
