...
<body class="pageHolder">
    ...
    <main>
        <fieldset id="userInfo">
            ...
            $stmt = $conn->prepare("SELECT name, surname, email, type FROM users_teamPropaganda WHERE id_users=?");
            ...
            echo "<form-input class='validate' value-id='name' label='Jméno:' type='text' do-change-check value='$name' original-value='$name'></form-input>";
            echo "<form-input class='validate' value-id='surname' label='Přijmení:' type='text' do-change-check value='$surname' original-value='$surname'></form-input>";
