...
<body>
    ...
    <table>
        ...
        foreach ($files as $file) {
            echo "<tr><td>$file</td><td><button file='$file' class='delete'>
            ...
            </button><button file='$file' class='templateChange'>
    ...
    <label for="name">Název souboru:</label>
    ...
    <button id="savenew">Uložit jako nový dokument</button>
    ...
    <script type="module">
        ...
        function templateChange(template) {
            ...
            if (template == "none") {
                ...
                document.getElementById("name").value = template;
            }
        }
