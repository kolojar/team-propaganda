...
<body>
                ...
                if ($stmt->num_rows > 0) {
                    while ($user = $stmt->fetch_assoc()) {
                        ...
                        if (file_exists("../files/" . $_GET["file"] . "/" . $user["id_users"] . "." . explode(".", $_GET["file"])[1])) {
                            echo "<button class='purkynkaButton' file='" . $_GET["file"] . "/" . $user["id_users"] . "." . explode(".", $_GET["file"])[1] . "' class='show formButton'><svg width='20' height='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
 ...
 <path d='M12.0004 15C13.6573 15 15.0004 13.6569 15.0004 12C15.0004 10.3431 13.6573 9 12.0004 9C10.3435 9 9.0004 10.3431 9.0004 12C9.0004 13.6569 10.3435 15 12.0004 15Z' stroke='black' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>
            ...
            <div style="text-align: right;">
                <button id="addFolder" class='purkynkaButton' form-icon><svg width="50" height="50" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>Vytvořit složku</span></button>
                <button id="addFile" class='purkynkaButton' form-icon><svg width="50" height="50" viewBox="0 0 2 2" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none" fill-rule="evenodd">
                            <path d="M0 0h2v2H0z" />
                            <path d="m1.376 0 .499.626V2H.125V0zm-.06.125H.25v1.75h1.5V.67zm-.253.563v.313h.313v.125h-.313v.313H.938v-.313H.625v-.125h.313V.688z" fill="#000" fill-rule="nonzero" />
                        </g>
                    </svg><span>Vytvořit soubor</span></button>
            </div>
            <table>
                <tr>
                    <th>Akce</th>
                ...
                while ($file = $files->fetch_assoc()) {
                    ...
                    if ($file["isDir"] == 1 && is_dir("../files/" . $file["name"])) {
                        echo "<button form-icon class='purkynkaButton' file='" . $file["name"] . "' class='showDir'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 32 32'>
