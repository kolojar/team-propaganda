...
//}
export function SetupSaveCancelButtons(holderId, cancelURL, postURL, id, className = "validate", onSaveFunc = null) {
    var _a;
    let holder = null;
    if (holderId == null) {
...
export function setupTableDeleteButtons(postURL, idAttributeName) {
    //Get buttons
